...
if (isset($_GET['edit'])) {
    ...
    $req = $connexion->query("SELECT * FROM depenses Where id = '$id'");
    $var = $req->fetchAll();
...
if (isset($_POST['modifier'])) {
     $id = $_GET['edit'];
    $req = $connexion->prepare("UPDATE depenses SET intitule=:intitule, montant=:montant WHERE id = $id LIMIT 1");
                                ...
                                <div class="dropdown row gx-5 justify-content-center">
                                    ...
                                    <form method="POST">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input class="form-control" type="hidden" value="<?php echo $id;  ?>" name="idDep" placeholder="Enter your name..." required />
                                        ...
                                        <!-- Submit Button-->
                                        <div class="d-grid"><button class="btn btn-primary btn-lg " name="modifier" type="submit">Modifier depense</button></div> <br>
